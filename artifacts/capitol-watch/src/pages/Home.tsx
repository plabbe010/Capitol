...
const DEMO_TRADES: Trade[] = [
  { ticker:"ICHR", asset:"Ichor Holdings", representative:"Debbie Wasserman Schultz", party:"D", state:"FL", chamber:"House", type:"Purchase", amount:"$1,001 - $15,000", date:"2025-08-05", filed:"2025-08-28", committees:["Appropriations","Energy & Water"], isMemberFirst:true, flagTier:"alert", flagReasons:["First purchase of ICHR by this member on record","On Appropriations committee — directly oversees this sector"] },
  { ticker:"NVDA", asset:"NVIDIA Corporation", representative:"Nancy Pelosi", party:"D", state:"CA", chamber:"House", type:"Purchase", amount:"$1,000,001 - $5,000,000", date:"2026-01-15", filed:"2026-02-10", committees:["Financial Services"], isMemberFirst:false, flagTier:"alert", flagReasons:["Bipartisan signal — both D & R buying within 30 days"] },
